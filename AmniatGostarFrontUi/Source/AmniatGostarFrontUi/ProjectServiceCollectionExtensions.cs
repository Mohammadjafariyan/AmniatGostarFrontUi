namespace AmniatGostarFrontUi;

using AmniatGostarFrontUi.Commands;
using AmniatGostarFrontUi.Mappers;
using AmniatGostarFrontUi.Repositories;
using AmniatGostarFrontUi.Services;
using AmniatGostarFrontUi.ViewModels;
using Boxed.Mapping;
...
internal static class ProjectServiceCollectionExtensions
{
    public static IServiceCollection AddProjectCommands(this IServiceCollection services) =>
        services
            ...
            .AddScoped<GetProductOptionsCommand>()
        ;
